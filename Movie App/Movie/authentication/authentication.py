...
def register():
    ...
    return render_template(
        ...
        TandC=True, watchlist=utilities.get_watchlist())
...
def login():
    ...
    return render_template(
        ...
        form=form, TandC=False, watchlist=utilities.get_watchlist()
    )
...
def user_page():
    try:
        ...
        if not len(reviews):
            rev_tr = False
        return render_template("authentication/user_page.html", rev_tr=rev_tr, reviews=reviews, username=session['username'],watchlist=utilities.get_watchlist())
